...
namespace Tests.IntegrationTests.RepositoriesTests
{
    public class ToDoCategoryRepositoryTests : IAsyncLifetime
    {
        ...
        private readonly Mock<ILogger<ToDoCategoryRepository>> _loggerMock;
        ...
        public ToDoCategoryRepositoryTests()
        {
            ...
            _loggerMock = new Mock<ILogger<ToDoCategoryRepository>>();

            _categoryRepository = new ToDoCategoryRepository(_context, _loggerMock.Object);
        }
