...
namespace Core.Interfaces
{
    ...
    public interface IToDoCategoryService
    {
        ...
        Task<ToDoCategory?> GetToDoCategoryByCategoryNameAsync(Guid userId, string toDoCategoryName);
        ...
        /// <param name="userId">The unique identifier of the user.</param>
        Task DeleteToDoCategoryAsync(Guid userId, string toDoCategoryName);
    }
}
